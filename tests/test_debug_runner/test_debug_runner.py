...
from tools import parse_xyz_data, assert_dictionary, cleanup, reset_directory, suppress_stdout


class Test_debug_runner(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        reset_directory()
        os.chdir('test_debug_runner')

    def test_jobs(self):

        print('Running test_debug_runner.py')
